...
import top.valliam.earthquakemonitorsystem.config.exception.CommonJsonException;
...
public class CommonUtil {
     ...
     *
     * @Author: Valliam
     * @Date: 9:46 下午 2019/11/12
     * @return: 返回一个info为空对象的成功消息的json
     **/
